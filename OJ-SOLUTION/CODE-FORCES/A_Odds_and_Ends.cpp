...
int main()
{
    ...
    //if first and last elemtn is even,its not possible to follow rules
    // if n is even is not possible 
    // what will be when even number in middle,we just consider full array
